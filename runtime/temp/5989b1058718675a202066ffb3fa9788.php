<?php /*a:3:{s:86:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/user/deleindex.html";i:1517572376;s:85:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/public/header.html";i:1541476479;s:85:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/public/footer.html";i:1541487880;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('user/index'); ?>">
        <div class="text-c"> 日期范围：
            <input type="text" name="start_time" value="<?php echo htmlentities($start_time); ?>" onfocus="WdatePicker()" id="datemin"
                   class="input-text Wdate" style="width:120px;">

            <input type="text" name="end_time" value="<?php echo htmlentities($end_time); ?>" onfocus="WdatePicker()" id="datemax"
                   class="input-text Wdate" style="width:120px;">
            <input type="text" name="username" value="<?php echo htmlentities($username); ?>" class="input-text" style="width:250px"
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td><u style="cursor:pointer" class="text-primary"
                       onclick="member_show('张三','member-show.html','10001','360','400')"><?php echo htmlentities($vo['username']); ?></u></td>
                <td><?php echo htmlentities($vo['mobile']); ?></td>
                <td><?php echo htmlentities($vo['email']); ?></td>
                <td><?php echo htmlentities($vo['create_time']); ?></td>
                <td class="text-l"><?php echo htmlentities($vo['last_login_time']); ?></td>
                <td class="td-status"><?php echo htmlentities(status($vo['status'])); ?></td>
                <td class="td-manage"><a style="text-decoration:none" onClick="member_stop(this,'10001')"
                                         href="<?php echo url('user/status',['id'=>$vo['id'],'status'=>1]); ?>" title="恢复"><i class="Hui-iconfont">&#xe631;</i></a> <a
                        style="text-decoration:none" class="ml-5"
                        href="#"
                        title="修改密码" onClick="o2o_s_edit('编辑','<?php echo url('user/edit',['id'=>$vo['id']]); ?>','',300)"><i class="Hui-iconfont">&#xe63f;</i></a>
