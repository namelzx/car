            ...
            <div class="" sign="usercenter_center" avalonctrl="usercenter_center">
                <div class=" font-s16 user_center">
                    ...
                    <div class="main">
                        ...
                        <div class="row relative bg_white border-b">
                            <i class="iconfont icon-huiyuanqia ml_15 font-s20  absolute-l"></i> <span class="ml_45">我的车宝呗</span>
                            <i class="iconfont icon-rightArrow-copy fr mr_15 font-s15 pt_2 absolute-r"></i>
                        </div>
                        <div class="row relative bg_white border-b">
                            <i class="iconfont icon-cheliang ml_15 font-s18  absolute-l mt_2"></i> <span class="ml_45">我的爱车</span>
                            <i class="iconfont icon-rightArrow-copy fr mr_15 font-s15 pt_2 absolute-r"></i>
                        </div>
                        <div class="row relative bg_white border-b hidden">
                            <i class="iconfont icon-dizhi ml_15 font-s20 absolute-l mt_2"></i> <span
                                class="ml_45">常用地址</span>
                            <i class="iconfont icon-rightArrow-copy fr mr_15 font-s15 pt_2 absolute-r"></i>
                        </div>
                        <div class="row relative bg_white border-b">
