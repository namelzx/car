<?php /*a:3:{s:80:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/city/add.html";i:1527751173;s:85:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/public/header.html";i:1543127366;s:85:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/public/footer.html";i:1541487880;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<form class="form form-horizontal form-o2o-add" id="form-o2o-add" method="post" action="<?php echo url('city/save'); ?>">
		<div class="row cl">
			...
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>城市英文代码：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>下级栏目：</label>
			<div class="formControls col-xs-8 col-sm-9">
